...
# new priors for hurdle_cratio() family
...
p <- out_both %>%
    ...
    labs(x = "Estimates", 
        y = "Coef",
        title = "Comparing coefficients between cratio and hurdle_cratio models") +
